...
class Main:
    ...
    def banner(r):
        ...
        text = f.read()
        f.close()
        f = open("Banners/Banner1.txt", "r", newline=None)
        header = f.read()
        f.close()
        print(Font.Color.GREEN + header + Font.Color.WHITE)
        print(Font.Color.WHITE + "---------------------------------------------------------------------")
        print(Font.Color.GREEN + text                                                                
        +
        Font.Color.WHITE + "| A COMPLETE OSINT TOOL:)      " + Font.Color.GREEN + "NOTDEAD" + Font.Color.WHITE + "                      |\n|                                                                   |")
        print(Font.Color.WHITE + "|[+]" + Font.Color.GREEN + "VERSION:" + version + Font.Color.WHITE + "                                           |")
        print(
            Font.Color.YELLOW + "| NOTDEAD · OSINT · configure contacts in Devilx.py if you ship it |")
        print(Font.Color.WHITE + "---------------------------------------------------------------------")
            ...
            try:
                ...
                if sce == 1:
                    ...
                    while username == "" :
                        username = str(input(
                        Font.Color.BLUE + "\n[+]" + Font.Color.WHITE + "INSERT THE USERNAME" + Font.Color.GREEN + "\n\n[#NOTDEAD#]" + Font.Color.WHITE + "-->"))
                    Searcher.Devilx.search(username)
